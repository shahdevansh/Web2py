...
# ## auxiliary functions
#     and 
#1. Show all song names of singer with id 3.
#2. Show all song names of singer 'Balu'
#3. Show all song names of singer 'Balu' in movie 'Shankarabharanam'
#4. Show all song names and singing_actors of singer 'Balu' in all movies earlier
#than year 2000
#5. Show all song names and singer names with rating 4 or more.
#
# ###########################################################
